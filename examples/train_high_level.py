...
import hrl_nav
from hrl_nav.normalizer import HighLevelNormalizer
...
if __name__ == '__main__':
    variant = dict(
        ...
        replay_buffer_kwargs=dict(
            max_size=int(5E6), 
            fraction_goals_rollout_goals=0.2, # with HER 
    ...
    low_level_agent = torch.load(variant['low_level_agent_params'])['evaluation/policy']
